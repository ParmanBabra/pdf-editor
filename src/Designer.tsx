...
function App() {
  ...
  async function getFont() {
    const font = {
      THSarabunNewBold: {
        data: await fetch("fonts/THSarabunNew/THSarabunNew Bold.ttf").then(
          (res) => res.arrayBuffer()
        ),
      },
      THSarabunNewBoldItalic: {
        data: await fetch(
          "fonts/THSarabunNew/THSarabunNew BoldItalic.ttf"
        ).then((res) => res.arrayBuffer()),
      },
      THSarabunNewItalic: {
        data: await fetch("fonts/THSarabunNew/THSarabunNew Italic.ttf").then(
          (res) => res.arrayBuffer()
        ),
      },
      THSarabunNew: {
        data: await fetch("fonts/THSarabunNew/THSarabunNew.ttf").then((res) =>
          res.arrayBuffer()
        ),
        fallback: true,
      },
